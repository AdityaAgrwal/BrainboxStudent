...
import com.brainbox.student.activities.YoutubeVideoActivity;
 ...
 */
public class SchoolDetailsRecyclerAdapter extends RecyclerView.Adapter<SchoolDetailsRecyclerAdapter.VersionViewHolder> {
	...
	public SchoolDetailsRecyclerAdapter(Context context) {
		isHomeList = true;
	...
	public SchoolDetailsRecyclerAdapter(Context context, String[] data, String[] values) {
		isHomeList = false;
		this.context = context;
		this.values = values;
		this.data = data;
